...
import PhoneModal from "@/pages/User/UserInfo/components/Security/components/PhoneModal";
import PasswordModal from "@/pages/User/UserInfo/components/Security/components/PasswordModal";
import EmailModal from "@/pages/User/UserInfo/components/Security/components/EmailModal";
    ...
    <>
      {
        ...
        <>
          ...
          <PhoneModal
            ...
            onOk={(newPhone: any)=>{setCurrentUser({...currentUser, phone: newPhone})}}/>
          <EmailModal
            visible={emailModal}
            onCancel={()=>setEmailModal(false)}
            onOk={(newEmail: any)=>{setCurrentUser({...currentUser, email: newEmail})}}
          />
          <PasswordModal
